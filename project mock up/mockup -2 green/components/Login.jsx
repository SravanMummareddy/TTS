const LoginPage = ({ navigate }) => {
  ...
  const inputStyle = {
    ...
    color:'var(--t1)', padding:'12px 16px', borderRadius:'10px',
    fontFamily:'var(--font)', fontSize:'14px', fontWeight:500, outline:'none', transition:'border-color 0.2s',
  };
  ...
  return (
    <div style={{ height:'100vh', display:'flex', position:'relative', background:'var(--bg)', overflow:'hidden', fontFamily:'var(--font)' }}>
      ...
      {/* Back */}
      <button onClick={() => navigate('landing')} style={{ position:'absolute', top:'24px', left:'32px', background:'transparent', border:'none', color:'var(--t3)', fontFamily:'var(--font)', fontSize:'13px', fontWeight:500, cursor:'pointer', display:'flex', alignItems:'center', gap:'7px', zIndex:10, transition:'color 0.2s' }}

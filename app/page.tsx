  ...
  return (
    <div style={{ height: '100vh', overflowY: 'auto', overflowX: 'hidden', background: 'var(--bg)', position: 'relative', fontFamily: 'var(--font)' }}>
      ...
      <section style={{ padding: isMobile ? '40px 20px 80px' : '60px 56px 100px', textAlign: 'center', position: 'relative', zIndex: 1, background: 'linear-gradient(to bottom,transparent,rgba(124,92,252,0.05),transparent)' }}>
        ...
        <button onClick={() => router.push('/login')}
          style={{ padding: '16px 44px', background: 'linear-gradient(135deg,var(--purple),var(--purple-d))', border: 'none', borderRadius: '12px', color: 'white', fontFamily: 'var(--font)', fontSize: '16px', fontWeight: 700, cursor: 'pointer', boxShadow: '0 8px 40px var(--purple-g)', transition: 'transform 0.2s' }}
